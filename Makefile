...
IS_java8_al2023 := java8.al2023
IS_java11 := java11
IS_java11_al2023 := java11.al2023
IS_java17 := java17
IS_java17_al2023 := java17.al2023
IS_java21 := java21
IS_java25 := java25
IS_nodejs16x := nodejs16.x
IS_nodejs18x := nodejs18.x
IS_nodejs20x := nodejs20.x
IS_nodejs22x := nodejs22.x
IS_nodejs24x := nodejs24.x
